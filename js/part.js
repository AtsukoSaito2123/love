...
============================================= */
    ...
    gsap.registerPlugin(ScrollTrigger);
        ...
        // Case 1
        TL.to(".element1", { opacity: 1, y: 0 })
            .to(".item1", { yPercent: -110, xPercent: -65, color: "#fff" }, "tl1")
            .to([".span1", ".span3"], { borderBottomColor: "#fff" }, "tl1")
            .to([".img1", ".circle1"], { opacity: 0 }, "tl1")
            .to(".bg1", { background: "transparent" }, "tl1")
            .to(".element1", { opacity: 0, duration: 0.2 }, "tl1")
            .to(".mask", { background: "#658896" }, "tl1")
            .to(".item2", { yPercent: 110, xPercent: -65, color: "#000" }, "tl1")
            .to([".span2"], { borderBottomColor: "#000" }, "tl1")
            .to([".img2", ".circle2"], { opacity: 1 }, "tl1")
            .to(".bg2", { background: "#fff" }, "tl1")
            .to(".element2", { opacity: 1, y: 0 }, "tl1")
            .to(".item3", { yPercent: 0, xPercent: 130 }, "tl1")
            .to(".img3", { opacity: 0 }, "tl1")
            .to(".circle3", { opacity: 0 }, "tl1")
            .to(".bg3", { background: "transparent" }, "tl1");

        // Case 2
        TL.to(".item1", { yPercent: -110, xPercent: 65, color: "#fff" }, "tl2")
            .to(".item2", { yPercent: 0, xPercent: -130, color: "#fff" }, "tl2")
            .to([".span2", ".span3"], { borderBottomColor: "#fff" }, "tl2")
            .to([".img2", ".circle2"], { opacity: 0 }, "tl2")
            .to(".bg2", { background: "transparent" }, "tl2")
            .to(".element2", { opacity: 0, duration: 0.2 }, "tl2")
            .to(".item3", { yPercent: 110, xPercent: 65, color: "#000" }, "tl2")
            .to(".element3", { opacity: 1, y: 0 }, "tl2")
            .to(".mask", { background: "#798D8A" }, "tl2")
            .to([".span3"], { borderBottomColor: "#000" }, "tl2")
            .to([".img3", ".circle3"], { opacity: 1 }, "tl2")
            .to(".bg3", { background: "#fff" }, "tl2");

            // transitions.forEach(({ items, properties, timeline }) => {
            //     const tween = gsap.to(items, properties, timeline ? tlParams[timeline] : undefined);
            //     if (timeline) {
            //         TL.add(tween, timeline);
            //     } else {
            //         TL.add(tween);
            //     }
            // });
